...
1.  **Navegar para a pasta**
    Navegue no seu terminal para a pasta `backend-rastreamento`.

2.  **Instalar Dependências**
    Execute o comando para instalar todos os pacotes necessários:
...
4.  **Configurar Variáveis de Ambiente**
    Crie um ficheiro chamado `.env` na raiz da pasta `backend-rastreamento`. Este ficheiro guardará as suas credenciais de banco de dados de forma segura. Adicione as seguintes variáveis:
...
1.  Abra o Postman.
2.  Certifique-se de que o seu servidor Node.js (`npm run dev`) está a correr.
3.  Crie novas requisições para testar as rotas.
